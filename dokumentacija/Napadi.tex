...
\begin{figure}[H]
	\centering
	\subfloat[\centering Originalna slika]{{\includegraphics[width=4.5cm]{slike/napadi/FGSM_eps0.png} }}%
	\qquad
	\subfloat[\centering $\epsilon = 0.01$]{{\includegraphics[width=4.5cm]{slike/napadi/FGSM_eps0.01.png} }}%
	\qquad
	\subfloat[\centering  $\epsilon = 0.1$]{{\includegraphics[width=4.5cm]{slike/napadi/FGSM_eps0.1.png} }}%
	\qquad
	\subfloat[\centering  $\epsilon = 0.25$]{{\includegraphics[width=4.5cm]{slike/napadi/FGSM_eps0.25.png} }}%
